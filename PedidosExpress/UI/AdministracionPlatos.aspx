...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    &nbsp;
        ...
        <div class="row1" style="background-color: yellowgreen">
        ...
        <div class="row2" style="background-color: darkslategray">
            <div class="col-sm-1 col-md-3">
            <div class="form">
                <br />
                <div class="form-group">
         ...
         <div class="row3" style="background-color: yellowgreen">
            <div class="col-sm-1 col-md-3">
            <div class="form">
                <br />
                <div class="form-group">
    ...
    <div class="row4" style="background-color: darkslategray">
        <div class="col-sm-1 col-md-3">
            <div class="form">
                <br />
                <div class="form-group">
